...
class RobotObjectMCGDFStep(nn.Module):
    ...
    def object_dynamics(
        self, F_c: torch.Tensor, object_quat: torch.Tensor, object_ang_vel: torch.Tensor,
        ...
        gravity_acc[:, 2] = -9.81
        lin_acc = gravity_acc + F_c[:, :3] / mass
    ...
    def forward(
        ...
        lin_acc, ang_acc, gravity_acc = self.object_dynamics(F_c, object_quat, object_ang_vel, object_context)
        ...
        aux = {
            ...
            "object_lin_acc": lin_acc, "object_ang_acc": ang_acc, "object_gravity_acc": gravity_acc,
            "object_inertial_force": object_context[:, :1].clamp_min(1.0e-4) * lin_acc,
            "object_gravity_force": object_context[:, :1].clamp_min(1.0e-4) * gravity_acc,
