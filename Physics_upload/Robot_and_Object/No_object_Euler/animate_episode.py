...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--checkpoint", type=str, 
        default="/home/sungkwon/IsaacLab-RE0409/IsaacLab-main/scripts/world_model/Physics/Robot_and_Object/No_object_Euler/outputs_mcgdf/run_20260608_171124/best.pt",
...
def load_checkpoint_model(path: str, device: torch.device):
    ...
    model = MultiStepRobotObjectMCGDFWorldModel(
        ...
        coupling_hidden_dim=int(cfg.get("coupling_hidden_dim", 64)),
        coupling_depth=int(cfg.get("coupling_depth", 2)),
        coupling_components=int(cfg.get("coupling_components", 1)),
        init_rho_v=float(cfg.get("init_rho_v", 0.95)),
        init_rho_omega=float(cfg.get("init_rho_omega", 0.95)),
