...
class TrainConfig:
    ...
    # Coupling head sizes / shape.
    coupling_hidden_dim: int
    coupling_depth: int
    coupling_components: int
    init_rho_v: float
    init_rho_omega: float
...
def parse_args() -> TrainConfig:
    ...
    parser.add_argument("--coupling_hidden_dim", type=int, default=64,
                        help="Hidden width of the alpha-coupling MLP.")
    parser.add_argument("--coupling_depth", type=int, default=2,
                        help="Number of hidden layers in the alpha-coupling MLP.")
    parser.add_argument(
        "--coupling_components", type=int, default=1, choices=[1, 2],
        help="1 = single rigid alpha; 2 = (alpha_rigid, alpha_slide) "
             "with separate linear / angular gating.",
    )
    parser.add_argument(
        "--init_rho_v", type=float, default=0.95,
        help="Initial passive linear-velocity decay scalar in (0,1).",
    )
    parser.add_argument(
        "--init_rho_omega", type=float, default=0.95,
        help="Initial passive angular-velocity decay scalar in (0,1).",
    )
    parser.add_argument(
...
def main() -> None:
    ...
    model = MultiStepRobotObjectMCGDFWorldModel(
        ...
        coupling_depth=cfg.coupling_depth,
        coupling_components=cfg.coupling_components,
        init_rho_v=cfg.init_rho_v,
        init_rho_omega=cfg.init_rho_omega,
