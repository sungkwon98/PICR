...
from .delan import DeLaNCore, DelanTerms, validate_ode_solver
from .utils import integrate_quat, normalize_quat, safe_solve
...
class WholeDeLaNWMDynamics(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        self.state_dim = 2 * self.robot_dof + 13
    ...
    def forward(
        ...
        *,
        ...
        for step in range(future_torques.shape[1]):
            ...
            state, aux = self.step(state, torque, z=z, return_aux=return_aux)
    ...
    def step(
        ...
        *,
        ...
        ddq_whole, terms = self.acceleration(q_whole, dq_whole, generalized_force, z=z)
    ...
    def state_derivative(
        ...
        *,
        ...
        ddq_whole, _terms = self.acceleration(q_whole, dq_whole, generalized_force, z=z)
    ...
    def integrate(
        ...
        *,
        ...
        return self._rk4_integrate(q_whole, dq_whole, generalized_force, z=z)
    ...
    def _rk4_integrate(
        ...
        *,
        ...
        dt = self.dt
        k1_q, k1_dq = self.state_derivative(q_whole, dq_whole, generalized_force, z=z)
